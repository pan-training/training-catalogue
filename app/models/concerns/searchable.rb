module Searchable
  ...
  class_methods do
    ...
    def search_and_filter_two_models(user, search_params = '', selected_facets = {}, model_1, model_2, page: 1, sort_by: nil, per_page: 30)
        #need to understand what includes does in search_and_filter
        search = Sunspot.search model_1, model_2 do            
            fulltext  search_params
            # Set the search parameter
            # Disjunction clause        
            active_facets = {}
