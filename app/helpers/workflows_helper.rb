module WorkflowsHelper
  ...
  WORKFLOWS_INFO = "Training workflows in in our #{TeSS::Config.generic_name} are visual, step-by-step protocols that allow users to navigate materials in this catalogue in topic- or task-related ways.\n\n"+
