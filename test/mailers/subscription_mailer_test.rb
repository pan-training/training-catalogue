...
class SubscriptionMailerTest < ActionMailer::TestCase
  ...
  test 'text digest' do
    ...
    assert_equal 'PaN-Training weekly digest - 2 new materials matching your criteria', email.subject
  ...
  test 'html event digest' do
    ...
    assert_equal [TeSS::Config.sender_email], email.from
    assert_equal [sub.user.email], email.to
    assert_equal "PaN-Training weekly digest - #{e.length} new events matching your criteria", email.subject
