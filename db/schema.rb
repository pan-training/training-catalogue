...
ActiveRecord::Schema.define(version: 2021_11_12_100937) do
  ...
  create_table "bcontributors_materials", id: false, force: :cascade do |t|
    ...
    t.bigint "material_id", null: false
    t.index ["bcontributor_id", "material_id"], name: "index_bctribs_materials_on_bctrib_id_and_material_id"
    t.index ["material_id", "bcontributor_id"], name: "index_bctribs_materials_on_material_id_and_bctrib_id"
  end
